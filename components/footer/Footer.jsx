    ...
    <>
        <footer className="footer p-10 bg-base-200 text-base-content">
            <div>
                ...
                <Link href="/subjects">
                    <a className="link link-hover">Предметы</a> 
                </Link>
                <Link href="/teachers">
                    <a className="link link-hover">Преподаватели</a> 
                </Link>
                <Link href="/support">
                    <a className="link link-hover">Поддержка</a>
                </Link>
            </div> 
            <div>
                <span className="footer-title">Связаться с нами</span> 
                <a className="link link-hover">+7 777 777 77 77</a> 
                <a className="link link-hover">emaiil@mail.com</a> 
                <a className="link link-hover">Часто задаваемые вопросы</a>
            </div> 
            <div>
                <span className="footer-title">Подпишитесь, чтобы быть в курсе последних новостей</span> 
                <div className="form-control w-80">
                    <label className="label">
                        <span className="label-text">Введите свой email</span>
                    </label> 
        ...
        <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
            <div className="items-center grid-flow-col">
                ...
                <p><span className="text-bold">Teach2U</span><br />Работаем с 2022 года</p>
            </div> 
